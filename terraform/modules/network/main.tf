...
# Private subnets — host the ECS tasks; no direct internet ingress
...
# Single NAT gateway keeps costs down for a portfolio project. A prod
# system serving real traffic would use one NAT per AZ for resilience —
# noted here and in the README as a deliberate, documented trade-off.
